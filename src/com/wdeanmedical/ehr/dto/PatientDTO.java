...
public class PatientDTO extends AuthorizedDTO {
  ...
  private String serviceEventOrdinal;
  private boolean checkIn;
  private boolean provider;
  private boolean missing;
  private boolean completed;
  private int patientEncounterGroupId;
  private int dentalProcedureId;
  private int drugItemId;
  private int imagingTestId;
  private int labTestId;
  private int dmeCodeId;
  ...
  private Integer dmeTypeId;
  private Integer imagingCodeId;
  private Integer labCodeId;
  private Integer drugCodeId;
  private Integer quantity;
  private Integer dentalProcedureCodeId;

  public PatientDTO() {
  }

  public String getServiceEventOrdinal() { return serviceEventOrdinal; }
  public void setServiceEventOrdinal(String serviceEventOrdinal) { this.serviceEventOrdinal = serviceEventOrdinal; }
  ...
  public String getPatientNameFilter() { return patientNameFilter; }
  public void setPatientNameFilter(String patientNameFilter) { this.patientNameFilter = patientNameFilter; }
  ...
  public int getDMECodeId() { return dmeCodeId; }
  public void setDMECodeId(int dmeCodeId) { this.dmeCodeId = dmeCodeId; }
  ...
  public int getIcd10AMId() { return icd10AMId; }
  public void setIcd10AMId(int icd10amId) { icd10AMId = icd10amId; }
  ...
  public Integer getDMETypeId() { return dmeTypeId; }
  public void setDMETypeId(Integer dmeTypeId) { this.dmeTypeId = dmeTypeId; }

  public int getDentalProcedureId() { return dentalProcedureId; }
  public void setDentalProcedureId(int dentalProcedureId) { this.dentalProcedureId = dentalProcedureId; }

  public int getDrugItemId() { return drugItemId; }
  public void setDrugItemId(int drugItemId) { this.drugItemId = drugItemId; }

  public int getImagingTestId() { return imagingTestId; }
  public void setImagingTestId(int imagingTestId) { this.imagingTestId = imagingTestId; }
  ...
  public String getImagingTest() { return imagingTest; }
  public void setImagingTest(String imagingTest) { this.imagingTest = imagingTest; }
  
  public String getLabTest() { return labTest; }
  public void setLabTest(String labTest) { this.labTest = labTest; }

  public String getDrugItem() { return drugItem; }
  public void setDrugItem(String drugItem) { this.drugItem = drugItem; }

  public String getDentalProcedure() { return dentalProcedure; }
  public void setDentalProcedure(String dentalProcedure) { this.dentalProcedure = dentalProcedure; }

  public Integer getDmeTypeId() { return dmeTypeId; }
  public void setDmeTypeId(Integer dmeTypeId) { this.dmeTypeId = dmeTypeId; }

  public Integer getImagingCodeId() { return imagingCodeId; }
  public void setImagingCodeId(Integer imagingCodeId) { this.imagingCodeId = imagingCodeId; }

  public Integer getQuantity() { return quantity; }
  public void setQuantity(Integer quantity) { this.quantity = quantity; }

  public Integer getLabCodeId() { return labCodeId; }
  public void setLabCodeId(Integer labCodeId) { this.labCodeId = labCodeId; }

  public Integer getDrugCodeId() { return drugCodeId; }
  public void setDrugCodeId(Integer drugCodeId) { this.drugCodeId = drugCodeId; }
  
  public Integer getDentalProcedureCodeId() { return dentalProcedureCodeId; }
  public void setDentalProcedureCodeId(Integer dentalProcedureCodeId) { this.dentalProcedureCodeId = dentalProcedureCodeId; }
