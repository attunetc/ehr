...
function handleUserDetails(e) {
  ...
  RenderUtil.render('user_form', {formMode:'edit'}, function(s) { 
    ...
    $('#user-form-healthcare-professional-id-saved').html(clinicianToChange.healthcareProfessionalId);
    ...
    $('#user-form-healthcare-professional-id-saved').blur(function() { updateSavedUser("healthcareProfessionalId", $(this).html(), id); });
...
function saveNewUser() {
  ...
  var jsonData = JSON.stringify({ 
    ...
    healthcareProfessionalId: $('#user-form-healthcare-professional-id').val(), 
