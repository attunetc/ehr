...
public class Clinician extends BaseEntity implements Serializable {
  ...
  @Column(name = "healthcare_professional_id", unique=true)
  public String getHealthcareProfessionalId() { return healthcareProfessionalId; }
  public void setHealthcareProfessionalId(String healthcareProfessionalId) { this.healthcareProfessionalId = healthcareProfessionalId; }
