...
public class AppDAO extends SiteDAO {
  ...
  public List<DMEType> getDMECodes() throws Exception {
    Session session = this.getSession();
    Criteria crit = session.createCriteria(DMEType.class);
    List<DMEType> list = crit.list();
    return list;
  }
  
  
  
  public List<ImagingCode> getImagingCodes() throws Exception {
    Session session = this.getSession();
    Criteria crit = session.createCriteria(ImagingCode.class);
    List<ImagingCode> list = crit.list();
    return list;
  }
  ...
  public List<ICD10AM> searchICD10AM(String searchText) throws Exception {
    Session session = this.getSession();
    Criteria crit = session.createCriteria(ICD10AM.class);
    crit.add(Restrictions.ilike("description", searchText, MatchMode.ANYWHERE));
    List<ICD10AM> list = crit.list();
    return list;
  }
  ...
  public List<Patient> getFilteredPatients(
    ...
    if (patientNameFilter.length() > 0) {crit.add(Restrictions.eq("cred.patientName", patientNameFilter));}
  ...
  public List<Disposition> getDispositions() throws Exception {
    Session session = this.getSession();
    Criteria crit = session.createCriteria(Disposition.class);
    crit.addOrder(Order.asc("code"));
    List<Disposition> list = crit.list();
    return list;
  }
  
  
  
  public List<MDB> getMDBs() throws Exception {
    Session session = this.getSession();
    Criteria crit = session.createCriteria(MDB.class);
    crit.addOrder(Order.asc("code"));
    List<MDB> list = crit.list();
    return list;
  }
  
  
  
  public List<TriageCode> getTriageCodes() throws Exception {
    Session session = this.getSession();
    Criteria crit = session.createCriteria(TriageCode.class);
    crit.addOrder(Order.asc("code"));
    List<TriageCode> list =  crit.list();
    return list;
  }
