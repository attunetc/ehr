...
public class Permissions {
  ...
  public static void buildClinicianPermissionsMap() {
    ...
    clinicianPermissionsMap.put("/app/getEncounterTypeAheads",           new boolean[] {true,true});
    ...
    clinicianPermissionsMap.put("/app/searchICD10AM",                    new boolean[] {true,true});
    ...
    clinicianPermissionsMap.put("/patient/addDentalProcedure",           new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/addDMECode",                   new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/addDrugItem",                  new boolean[] {true,true});
    ...
    clinicianPermissionsMap.put("/patient/addImagingTest",               new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/addLabTest",                   new boolean[] {true,true});
    ...
    clinicianPermissionsMap.put("/patient/createED",                     new boolean[] {true,true});
    ...
    clinicianPermissionsMap.put("/patient/deleteDentalProcedure",        new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/deleteDMECode",                new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/deleteDrugItem",               new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/deleteDxCode",                 new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/deleteImagingTest",            new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/deleteLabTest",                new boolean[] {true,true});
    ...
    clinicianPermissionsMap.put("/patient/updateDentalProcedure",        new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/updateDMECode",                new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/updateDrugItem",               new boolean[] {true,true});
    ...
    clinicianPermissionsMap.put("/patient/updateImagingTest",            new boolean[] {true,true});
    clinicianPermissionsMap.put("/patient/updateLabTest",                new boolean[] {true,true});
