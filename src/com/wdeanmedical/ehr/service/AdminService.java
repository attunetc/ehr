...
public class AdminService {
  ...
  public  void saveNewClinician(AdminDTO dto) throws Exception {
   ...
   if(adminDAO.checkUsername(dto.getUsername()) == false) {
    ...
    clinician.setHealthcareProfessionalId(createHealthcareProfessionalId(clinician));
    adminDAO.update(clinician);
  }
  
  
  
  public String createHealthcareProfessionalId(Clinician clinician) throws Exception {
    return String.format("%06d", clinician.getId());
  }
  ...
  public void updateClinician(AdminDTO dto) throws Exception {
    ...
    else if (property.equals("healthcareProfessionalId")) {clinician.setHealthcareProfessionalId(value);} 
