...
public class PatientService {
  ...
  public void deleteDMECode(PatientDTO dto) throws Exception {
    DMEType dmeCode = patientDAO.findDMETypeById(dto.getDMECodeId());
    patientDAO.delete(dmeCode);
  }
  
  
  
  public void deleteImagingTest(PatientDTO dto) throws Exception {
    ImagingTest imagingTest = patientDAO.findImagingTestById(dto.getImagingTestId());
    patientDAO.delete(imagingTest);
  }
  
  
  
  public void deleteLabTest(PatientDTO dto) throws Exception {
    LabTest labTest = patientDAO.findLabTestById(dto.getLabTestId());
    patientDAO.delete(labTest);
  }
  
  
  
  public void deleteDentalProcedure(PatientDTO dto) throws Exception {
    DentalProcedure proc = patientDAO.findDentalProcedureById(dto.getDentalProcedureId());
    patientDAO.delete(proc);
  }
  
  
  
  public void deleteDrugItem(PatientDTO dto) throws Exception {
    DrugItem drugItem = patientDAO.findDrugItemById(dto.getDrugItemId());
    patientDAO.delete(drugItem);
  }
  ...
  public void createED(PatientDTO dto) throws Exception {
    Set<String> fieldSetED = activityLogService.getListOfChangedFields(dto.getEncounter().getED());
    patientDAO.update(dto.getEncounter().getED());
    patientDAO.update(dto.getEncounter());
    activityLogService.logEditEncounter(dto.getClinicianId(), dto.getPatientId(), dto.getClinicianId(), dto.getEncounterId(), fieldSetED);
  }
  ...
  public void updateDMECode(PatientDTO dto) throws Exception {
    DMECode dmeCode = patientDAO.findDMECodeById(dto.getDMECodeId());
    String property = dto.getUpdateProperty();
    dmeCode.setDMEType(patientDAO.findDMETypeById(dto.getDMETypeId()));
    Set<String> fieldSet = new HashSet<String>();
    fieldSet.add(property);
    patientDAO.update(dmeCode);
    activityLogService.logEditEncounter(dto.getClinicianId(), dto.getPatientId(), dto.getClinicianId(), dto.getEncounterId(), fieldSet);
  }
  ...
  public void updateDxCode(PatientDTO dto) throws Exception {
    DxCode dxCode = patientDAO.findDxCodeById(dto.getDxCodeId());
    String property = dto.getUpdateProperty();
    dxCode.setIcd10AM(patientDAO.findICD10AMById(dto.getIcd10AMId()));
    Set<String> fieldSet = new HashSet<String>();
    fieldSet.add(property);
  ...
  public void updateImagingTest(PatientDTO dto) throws Exception {
    ImagingTest imagingTest = patientDAO.findImagingTestById(dto.getImagingTestId());
    String property = dto.getUpdateProperty();
    if (property.equals("imagingCode")) {
      imagingTest.setImagingCode(patientDAO.findImagingCodeById(dto.getImagingCodeId()));
    }
    else if (property.equals("quantity")) {
      imagingTest.setQuantity(dto.getQuantity());
    }
    Set<String> fieldSet = new HashSet<String>();
    fieldSet.add(property);
    patientDAO.update(imagingTest);
    activityLogService.logEditEncounter(dto.getClinicianId(), dto.getPatientId(), dto.getClinicianId(), dto.getEncounterId(), fieldSet);
  }
  
  
  public void updateLabTest(PatientDTO dto) throws Exception {
    LabTest labTest = patientDAO.findLabTestById(dto.getLabTestId());
    String property = dto.getUpdateProperty();
    if (property.equals("labCode")) {
      labTest.setLabCode(patientDAO.findLabCodeById(dto.getLabCodeId()));
    }
    else if (property.equals("quantity")) {
      labTest.setQuantity(dto.getQuantity());
    }
    Set<String> fieldSet = new HashSet<String>();
    fieldSet.add(property);
    patientDAO.update(labTest);
    activityLogService.logEditEncounter(dto.getClinicianId(), dto.getPatientId(), dto.getClinicianId(), dto.getEncounterId(), fieldSet);
  }
  
  
  public void updateDrugItem(PatientDTO dto) throws Exception {
    DrugItem drugItem = patientDAO.findDrugItemById(dto.getDrugItemId());
    String property = dto.getUpdateProperty();
    if (property.equals("drugCode")) {
      drugItem.setDrugCode(patientDAO.findDrugCodeById(dto.getDrugCodeId()));
    }
    else if (property.equals("quantity")) {
      drugItem.setQuantity(dto.getQuantity());
    }
    Set<String> fieldSet = new HashSet<String>();
    fieldSet.add(property);
    patientDAO.update(drugItem);
    activityLogService.logEditEncounter(dto.getClinicianId(), dto.getPatientId(), dto.getClinicianId(), dto.getEncounterId(), fieldSet);
  }
  
  
  public void updateDentalProcedure(PatientDTO dto) throws Exception {
    DentalProcedure dentalProcedure = patientDAO.findDentalProcedureById(dto.getDentalProcedureId());
    String property = dto.getUpdateProperty();
    if (property.equals("dentalProcedureCode")) {
      dentalProcedure.setDentalProcedureCode(patientDAO.findDentalProcedureCodeById(dto.getDentalProcedureCodeId()));
    }
    else if (property.equals("quantity")) {
      dentalProcedure.setQuantity(dto.getQuantity());
    }
    Set<String> fieldSet = new HashSet<String>();
    fieldSet.add(property);
    patientDAO.update(dentalProcedure);
    activityLogService.logEditEncounter(dto.getClinicianId(), dto.getPatientId(), dto.getClinicianId(), dto.getEncounterId(), fieldSet);
  }
  ...
  public Integer addDMECode(Integer encounterId) throws Exception {
    DMECode dmeCode = new DMECode();
    dmeCode.setEncounterId(encounterId);
    patientDAO.create(dmeCode);
    return dmeCode.getId();
  }
  ...
  public Integer addImagingTest(Integer encounterId) throws Exception {
    ImagingTest imagingTest = new ImagingTest();
    imagingTest.setEncounterId(encounterId);
    patientDAO.create(imagingTest);
    return imagingTest.getId();
  }
  
  
  
  public Integer addLabTest(Integer encounterId) throws Exception {
    LabTest labTest = new LabTest();
    labTest.setEncounterId(encounterId);
    patientDAO.create(labTest);
    return labTest.getId();
  }
  
  
  
  public Integer addDrugItem(Integer encounterId) throws Exception {
    DrugItem drugItem = new DrugItem();
    drugItem.setEncounterId(encounterId);
    patientDAO.create(drugItem);
    return drugItem.getId();
  }
  
  
  
  public Integer addDentalProcedure(Integer encounterId) throws Exception {
    DentalProcedure dentalProcedure = new DentalProcedure();
    dentalProcedure.setEncounterId(encounterId);
    patientDAO.create(dentalProcedure);
    return dentalProcedure.getId();
  }
  ...
  public Encounter newEncounter(PatientDTO dto) throws Exception {
    ...
    for (int i=0; i<3; i++) {
      addDMECode(encounter.getId()); 
      addDxCode(encounter.getId()); 
      addTxCode(encounter.getId()); 
      addImagingTest(encounter.getId()); 
      addLabTest(encounter.getId()); 
      addDrugItem(encounter.getId()); 
      addDentalProcedure(encounter.getId()); 
  ...
  public void updatePatient(PatientDTO dto) throws Exception {
    ...
    if (property.equals("firstName")) {cred.setFirstName(DataEncryptor.encrypt(value));updateClass = "Credentials";} 
    ...
    else if (property.equals("patientName")) {cred.setPatientName(DataEncryptor.encrypt(value));updateClass = "Credentials";} 
    else if (property.equals("gender")) {demo.setGender(patientDAO.findGenderByCode(value));updateClass = "Demographics";} 
    else if (property.equals("serviceEventOrdinal")) {
      Integer seId; try { seId = new Integer(value); } catch (NumberFormatException nfe) {seId = null;}
      encounter.setServiceEventOrdinal(patientDAO.findServiceEventOrdinalById(seId));updateClass = "Encounter";
    } 
      ...
      Integer countryId; try { countryId = new Integer(value); } catch (NumberFormatException nfe) {countryId = null;}
      demo.setCountry(patientDAO.findCountryById(countryId));updateClass = "Demographics";
    } 
    else if (property.equals("nationality")) {
      Integer nationalityId; try { nationalityId = new Integer(value); } catch (NumberFormatException nfe) {nationalityId = null;}
      demo.setNationality(patientDAO.findCountryById(nationalityId));updateClass = "Demographics";
    }
    ...
    else if (property.equals("altId")) {cred.setAltId(DataEncryptor.encrypt(value));updateClass = "Credentials";} 
    ...
    else if (property.equals("primaryDxCode")) {ed.setPrimaryDxCode(patientDAO.findDxCodeFromCode(value));updateClass = "ED";} 
    else if (property.equals("satDxCode")) {ed.setPrimarySATDxCode(patientDAO.findDxCodeFromCode(value));updateClass = "ED";} 
    else if (property.equals("seeAndTreat")) {ed.setSeeAndTreat(new Boolean(value));updateClass = "ED";} 
    else if (property.equals("disposition")) {
      Integer dispId; try { dispId = new Integer(value); } catch (NumberFormatException nfe) {dispId = null;}
      ed.setDisposition(patientDAO.findDispositionById(dispId));updateClass = "ED";
    } 
    else if (property.equals("triageCode")) {
      Integer triageCodeId; try { triageCodeId = new Integer(value); } catch (NumberFormatException nfe) {triageCodeId = null;}
      ed.setTriageCode(patientDAO.findTriageCodeById(triageCodeId));updateClass = "ED";
    } 
    else if (property.equals("mdb")) {
      Integer mdbId; try { mdbId = new Integer(value); } catch (NumberFormatException nfe) {mdbId = null;}
      ed.setMdb(patientDAO.findMDBById(mdbId));updateClass = "ED";
    } 
    else if (property.equals("presentationDate")) {
      SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy HH:mm z");
      Date pd; try { pd = sdf.parse(value); } catch (ParseException pe) {pd = null;}
      ed.setPresentationDate(pd);
      updateClass = "ED";
    }
    else if (property.equals("commencementDate")) {
      SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy HH:mm z");
      Date cd; try { cd = sdf.parse(value); } catch (ParseException pe) {cd = null;}
      ed.setPresentationDate(cd);
      updateClass = "ED";
    }
    else if (property.equals("episodeEndDate")) {
      SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy HH:mm z");
      Date eed; try { eed = sdf.parse(value); } catch (ParseException pe) {eed = null;}
      ed.setPresentationDate(eed);
      updateClass = "ED";
    }
    ...
    else if(updateClass.equals("ED")) {patientDAO.update(ed);}
    ...
    else if(updateClass.equals("FollowUp")) {patientDAO.update(ed);}
   ...
   public void encrypt(Patient patient) throws Exception { 
     ...
     if (cred.getPatientName() != null) { cred.setPatientName(DataEncryptor.encrypt(cred.getPatientName()));}
     ...
     if (cred.getAltId() != null) { cred.setAltId(DataEncryptor.encrypt(cred.getAltId()));}
   ...
   public void decrypt(Patient patient) throws Exception { 
     ...
     if(Core.decryptedPatients.containsKey(patient.getId())){
       ...
       if (cred.getPatientName() != null) { cred.setPatientName(DataEncryptor.decrypt(cred.getPatientName()));}
       ...
       if (cred.getAltId() != null) { cred.setAltId(DataEncryptor.decrypt(cred.getAltId()));}
  ...
  public List<VisitType> getVisitTypes() throws Exception {
     return patientDAO.getVisitTypes();  
  } 
  
  public List<ServiceCategory> getServiceCategorys() throws Exception {
    return patientDAO.getServiceCategorys();  
 } 
