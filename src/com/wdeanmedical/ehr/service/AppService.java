...
public class AppService {
  ...
  public List<Patient> getFilteredPatients(PatientDTO dto) throws Exception {
    ...
    String patientNameFilter = dto.getPatientNameFilter(); 
    ...
    String encryptedPatientNameFilter = patientNameFilter.length() > 0 ? DataEncryptor.encrypt(capitalize(patientNameFilter)) : patientNameFilter;
  ...
  public List<ICD10AM> searchICD10AM(TerminologyDTO dto) throws Exception {
    return appDAO.searchICD10AM(dto.getSearchText());
  }
  ...
  public  boolean getEncounterTypeAheads(ClinicianDTO dto) throws Exception {
    dto.encounterTypeAheads.put("dmeCodes", appDAO.getDMECodes());
    dto.encounterTypeAheads.put("imagingCodes", appDAO.getImagingCodes());
    return true;
  }
  ...
  public  boolean getPatientSearchTypeAheads(ClinicianDTO dto) throws Exception {
    ...
    Set<String> patientNames = new TreeSet<String>();
    ...
    for (Patient patient : patients) {
      ...
      patientNames.add(patient.getCred().getPatientName());
    ...
    dto.patientSearchTypeAheads.put("patientNames", patientNames);
  ...
  public  boolean getPatientChart(PatientDTO dto) throws Exception {
    ...
    dto.setPatientName(patient.getCred().getPatientName());
    ...
    dto.setCountry(patient.getDemo().getCountry().getName());
    dto.setNationality(patient.getDemo().getCountry().getName());
  ...
  public String getStaticLists() throws Exception{
    ...
    map.put("countries", appDAO.getCountries());
    map.put("mdbs", appDAO.getMDBs());
    map.put("triageCodes", appDAO.getTriageCodes());
    map.put("dispositions", appDAO.getDispositions());
