...
public class AppServlet extends HttpServlet  {
    ...
    try { 
      if (pathInfo.equals("/getStaticLists")) {
        ...
        if (isValidSession(request, response) == false) {
          ...
          else if (pathInfo.equals("/getEncounterTypeAheads")) {
            returnString = getClinicianData(request, "/getEncounterTypeAheads");
          }
          ...
          else if (pathInfo.equals("/searchICD10AM")) {
            returnString = searchICD10AM(request, response);  
          }
  ...
  public String searchICD10AM(HttpServletRequest request, HttpServletResponse response) throws Exception {
    String searchText = request.getParameter("searchText");
    Gson gson = new Gson();
    TerminologyDTO dto = new TerminologyDTO(); 
    dto.setSearchText(searchText);
    List<ICD10AM> icd10AMList = appService.searchICD10AM(dto); 
    dto.setIcd10AMList(icd10AMList);
  ...
  public String getClinicianData(HttpServletRequest request, String pathAction) throws Exception {
    ...
    else if(pathAction.equals("/getEncounterTypeAheads")) {
      appService.getEncounterTypeAheads(dto);
    }
